            ...
            <div class="tambahan">
              ...
              <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-home1" role="tabpanel" aria-labelledby="pills-home-tab">   
                  ...
                  <?php foreach($dataPembayaran as $data){?>
                    <div class="d-flex justify-content-between mb-3 w-full formInput">
                      ...
                      <input type="number" class="form-control mr-3 saldoAwal" name="saldoAwal[]" placeholder="Masukan saldo...">
                      <input type="text" class="form-control mr-3 catatan" name="catatan[]" placeholder="Masukan catatan...">
                      <button type="button" class='btn btn-icon btn-success newInput'></button>
                    </div>
                  <?php }?>
                  </div>
                </div>
                <div class="tab-pane fade" id="pills-profile1" role="tabpanel" aria-labelledby="pills-profile-tab">
                  ...
                  <div class="d-flex justify-content-between mb-3">
                    <label for="penerima" class="form-label align-self-center mb-0 w-50 text-uppercase">Penerima</label>
                    <input type="text" id="penerima" class="form-control w-65 penerima" name="penerima" placeholder="Masukan nama penerima">
                  </div>
                </div>
              </div>
            </div>
