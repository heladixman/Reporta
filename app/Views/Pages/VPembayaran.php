...
<div class="content-wrapper">
    ...
    <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-sm-2 col-4">
            <button type="button" class="btn btn-sm btn-primary w-100 h-75" data-bs-toggle="modal" data-bs-target="#ModalNewPembayaran"><?= $addNewButton ?></button>
          </div>
        </div>
      </div>
    </section>
    ...
    <!-- Add Modals Here -->
    <?php echo view('PagesPart/Modals/ModalPembayaran.php');?>
</div>